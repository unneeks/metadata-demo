...
def add_lineage(from_fqn, to_fqn):
...
if __name__ == "__main__":
    ...
    add_lineage("trino_iceberg.iceberg.bronze.jira_issue_history", "trino_iceberg.iceberg.silver.silver_work_item")
    add_lineage("trino_iceberg.iceberg.silver.silver_work_item", "trino_iceberg.iceberg.gold.gold_employee_delivery")
    
    add_lineage("trino_iceberg.iceberg.bronze.servicenow_change_request", "trino_iceberg.iceberg.silver.silver_change")
    add_lineage("trino_iceberg.iceberg.bronze.servicenow_incident", "trino_iceberg.iceberg.silver.silver_incident")
    add_lineage("trino_iceberg.iceberg.silver.silver_change", "trino_iceberg.iceberg.gold.gold_change_quality")
